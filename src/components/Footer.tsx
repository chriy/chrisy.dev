export default function Footer() {
    ...
    return (
        <footer className="relative overflow-hidden mt-15 bg-neutral-900 dark:bg-dark-900">
            <svg className="absolute -bottom-30 start-1/2 w-[1900px] transform -translate-x-1/2" width="2745" height="488" viewBox="0 0 2745 488" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
                <div className="inline-flex items-center">
                    <p className="text-white font-bold font-stretch-100%">Chrisy</p>
