...
export default function BackTop() {
    ...
    return (
        <div className="mt-20 pb-6 flex flex-col items-center justify-center gap-4 cursor-pointer">
            <span className="text-[10px] tracking-[0.2em] text-zinc-300 dark:text-zinc-600 uppercase">The End</span>

            <button
                onClick={scrollToTop}
                className="group relative h-32 w-10 flex justify-center items-end"
